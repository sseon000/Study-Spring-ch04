...
public class BoardCommentDaoImplTest {
    ...
    public void delete() throws Exception {
        commentDao.deleteAll(1);
        BoardCommentDto commentDto = new BoardCommentDto(1, 0, "comment", "asdf");
    ...
    public void insert() throws Exception {
        ...
        commentDto = new BoardCommentDto(1, 0, "comment", "asdf");
        assertTrue(commentDao.insert(commentDto)==1);
    ...
    public void selectAll() throws Exception {
        ...
        List<BoardCommentDto> list = commentDao.selectAll(1);
    ...
    public void select() throws Exception {
        ...
        List<BoardCommentDto> list = commentDao.selectAll(1);
        String comment = list.get(0).getBoardcomment();
        String commenter = list.get(0).getCommenter();
        assertTrue(comment.equals(commentDto.getBoardcomment()));
    ...
    public void update() throws Exception {
        ...
        commentDto.setBoardcomment("comment2");
